...
{
	WebDriver driver;
	@FindBy(xpath="//input[@id='small-searchterms']") WebElement SearchField;
    @FindAll(@FindBy(xpath = "//ul/li[@class='ui-menu-item']")) List<WebElement> autoDropDownItems;
    ...
    @FindBy(xpath="//span[@id='price-value-1']") WebElement getTextMoney;
    @FindBy(xpath="//input[@id='product_enteredQuantity_1']") WebElement QtyField;
    @FindBy(xpath="//button[@id='add-to-cart-button-1']") WebElement AddToCart;
    @FindBy(xpath="//button[@id='add-to-wishlist-button-1']") WebElement AddToWishList;
    @FindBy(xpath="//button[normalize-space()='Add to compare list']") WebElement AddToCompareList;
    @FindBy(xpath="//button[normalize-space()='Email a friend']") WebElement EmailToFriend;
